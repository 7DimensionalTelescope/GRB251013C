#!/usr/bin/env python3
"""
Plotting script for final_model.py results
Generates best-fit light curves for all bands (XRT + all optical)
Shows component contributions: Core FS, Reverse Shock, Flare, Wing
"""
...
def plot_light_curves(outdir):
    ...
    from final_model import load_all_optical_data, XRT_BAND
...
def plot_spectral_index_comparison(outdir):
    ...
    from final_model import make_core_model, make_wing_model, spectral_index_model
...
def main():
    parser = argparse.ArgumentParser(description="Plot final_model.py results")
