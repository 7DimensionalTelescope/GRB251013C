...
class Fitter:
    ...
    def _run_bilby(self, sampler="dynesty", label="grb_fit", outdir="bilby_out", **kwargs):
        import bilby
        ...
        samples = posterior[self.params].to_numpy()
        ...
        self.results = {
            ...
            "weighted_samples": {"points": samples},
            "paramnames": self.params,
        }
        return self.sampler
