...
J=json.load(open("/home/dtak/research/grb/GRB251013C/analysis/2026-08_core_flare_team/data/jointfast.json"))
labels=J["labels"]
...
comp_x=compute_model_components(params,tg,None,XRT_BAND,True,True)
...
for d in lc:
    ...
    cm=compute_model_components(params,tg,d['frequency'],None,True,True)
...
cm=compute_model_components(params,sed_t,C_AA/wgrid,None,True,True)
...
fig.tight_layout()
fig.savefig("/home/dtak/research/grb/GRB251013C/analysis/2026-08_core_flare_team/figures/jointfast_lc.png",dpi=150)
print("saved jointfast_lc.png")
